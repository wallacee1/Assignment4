...
public class CalcEngine
{
    ...
    public CalcEngine()
    {
        ...
        previousOperator = ' ';
        leftOperand = 0;
        System.out.println("CalcEngine constructed. \n" + "displayValue: " + displayValue + ", previousOperator: " + previousOperator + ", leftOperand: " + leftOperand + ".\n");
    }
    ...
    {
        System.out.println("getDisplayValue called. Result: " + displayValue);
        return displayValue;
    }
    ...
    public void minus()
    {
        ...
        previousOperator = '-';
        displayValue = 0;
        System.out.println("end of minus");
    }
